...
import marcel.compiling.exceptions.*;
import marcel.compiling.more.ErrorModel;
...
public class ErrorHandlingController {
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public ErrorModel handlerCompilerException(CompilerException ne){
        return new ErrorModel(HttpStatus.BAD_REQUEST.value(), ne.getMessage());
    }

    @ExceptionHandler(VersionAlreadyCompiledException.class)
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public ErrorModel handlerVersionAlreadyCompiledException(VersionAlreadyCompiledException ne){
        return new ErrorModel(HttpStatus.BAD_REQUEST.value(), ne.getMessage());
    }
}